...
We maintain an iOS and Android version of the app and it is our preference to keep features standard between both apps. We would love you to check out the [iOS App code](https://github.com/rabid/nzsl-dictionary-ios) and consider contributing to both via Github Pull Requests.
...
This code is available under the [MIT license](https://github.com/rabid/nzsl-dictionary-android/blob/master/LICENSE.txt).
